...
{
	HGLOBAL Ver_Shader = LoadResource(0, FindResource(0, MAKEINTRESOURCE(RE_NON_LIGHT_VERTEX_SHADER), RT_RCDATA));
	HGLOBAL Frag_Shader = LoadResource(0, FindResource(0, MAKEINTRESOURCE(RE_NON_LIGHT_FRAGMENT_SHADER), RT_RCDATA));
